  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-4 border-t border-slate-100 dark:border-slate-900 bg-gradient-to-b from-white to-slate-50 dark:from-slate-950 dark:to-black">
          <div className="flex items-center gap-3 mb-4 p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden group">
            ...
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white text-xs font-bold shadow-md ring-2 ring-white dark:ring-slate-800">
              {user?.avatar || "US"}
            </div>
